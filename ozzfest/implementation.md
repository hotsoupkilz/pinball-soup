...
- Carousel band selection (highlights, switching, and selection verified)
...
### Test Checklist
- [x] Uncomment events_when_both in config.yaml
- [x] Start game and verify carousel mode starts on ball_starting
- [x] Press left magnasave - should highlight previous item
- [x] Press right magnasave - should highlight next item  
- [x] Press both magnasaves - should select and start band mode
- [x] Verify audio plays on highlight
- [x] Verify slide shows highlighted band name
...
1. [x] Uncomment combo_magnasave_both in config.yaml
2. [x] Test carousel mode with `mpf -vtX`
3. [x] Verify all 5 bands highlight correctly
4. [x] Verify audio plays on each highlight
5. [x] Verify selection fires correct events
